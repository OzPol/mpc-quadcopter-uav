...
# --- EXPERIMENT SETUP ---
# active_robot = 'standard_uav'         # Options: 'crazyflie_2_1', 'standard_uav'
# active_trajectory = 'circle'      # Options: 'circle', 'helix', 'lemniscate'

# active_robot = 'standard_uav'
# active_trajectory = 'lemniscate'

# active_robot = 'standard_uav'
# active_trajectory = 'helix'

# active_robot = 'crazyflie_2_1'          # Options: 'crazyflie_2_1', 'standard_uav'
# active_trajectory = 'circle'        # Options: 'circle', 'helix', 'lemniscate'

active_robot = 'crazyflie_2_1'
active_trajectory = 'lemniscate'
